<?php include 'include/header.php' ?>
    <title>Celebrant - Invitation</title>
...
<?php include 'include/menu.php' ?>
                    ...
                    <div class="slide-inner">
                        <div class="container">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-lg-5">
                                    <h2 data-swiper-parallax="-200">Invitation</h2>
                                </div>
                                <div class="col-lg-6">
                                    <div class="slideIMg">
                                        <figure>
    ...
    <section data-scroll-section class="emagzinePage">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="blogCard">
                        <figure class="reveal">
                            <img src="images/invitation1.jpg" alt="">
                        </figure>
                        <div class="blogContent">
                            <h6>Wedding Invitations</h6>
                            <p>Collating captured photos at the events and using these photos to make
                                E-magazine. Sending these E-magazine to preferred guest of the celebrators through our
                                website</p>
                ...
                <div class="col-md-6">
                    <div class="blogCard">
                        <figure class="reveal">
                            <img src="images/invitation2.jpg" alt="">
                        </figure>
                        <div class="blogContent">
                            <h6>Wedding Save The Dates</h6>
                            <p>Collating captured photos at the events and using these photos to make
                                E-magazine. Sending these E-magazine to preferred guest of the celebrators through our
                                website</p>
                            <a href="" class="themeBtn">Get Started</a>
                ...
                <div class="col-md-6">
                    <div class="blogCard">
                        <figure class="reveal">
                            <img src="images/invitation3.jpg" alt="">
                        </figure>
                        <div class="blogContent">
                            <h6>Business Invitations</h6>
                            <p>Collating captured photos at the events and using these photos to make
                                E-magazine. Sending these E-magazine to preferred guest of the celebrators through our
                                website</p>
                            <a href="" class="themeBtn">Get Started</a>
                ...
                <div class="col-md-6">
                    <div class="blogCard">
                        <figure class="reveal">
                            <img src="images/invitation4.jpg" alt="">
                        </figure>
                        <div class="blogContent">
                            <h6>Baby</h6>
                            <p>Collating captured photos at the events and using these photos to make
                ...
                <div class="col-md-6">
                    <div class="blogCard">
                        <figure class="reveal">
                            <img src="images/invitation5.jpg" alt="">
                        </figure>
                        <div class="blogContent">
                            <h6>Birthday Party Invitations</h6>
                            <p>Collating captured photos at the events and using these photos to make
                                E-magazine. Sending these E-magazine to preferred guest of the celebrators through our
                                website</p>
                            <a href="" class="themeBtn">Get Started</a>
                ...
                <div class="col-md-6">
                    <div class="blogCard">
                        <figure class="reveal">
                            <img src="images/invitation6.jpg" alt="">
                        </figure>
                        <div class="blogContent">
                            <h6>Holiday Cards</h6>
                            <p>Collating captured photos at the events and using these photos to make
                ...
                <div class="col-md-6">
                    <div class="blogCard">
                        <figure class="reveal">
                            <img src="images/invitation7.jpg" alt="">
                        </figure>
                        <div class="blogContent">
                            <h6>Holiday Invitations</h6>
                            <p>Collating captured photos at the events and using these photos to make
                                E-magazine. Sending these E-magazine to preferred guest of the celebrators through our
                                website</p>
                            <a href="" class="themeBtn">Get Started</a>
                ...
                <div class="col-md-6">
                    <div class="blogCard">
                        <figure class="reveal">
                            <img src="images/invitation8.jpg" alt="">
                        </figure>
                        <div class="blogContent">
                            <h6>Virtual / Remote Event</h6>
                            <p>Collating captured photos at the events and using these photos to make
                                E-magazine. Sending these E-magazine to preferred guest of the celebrators through our
                                website</p>
                            <a href="" class="themeBtn">Get Started</a>
                ...
                <div class="col-md-6">
                    <div class="blogCard">
                        <figure class="reveal">
                            <img src="images/invitation9.jpg" alt="">
                        </figure>
                        <div class="blogContent">
                            <h6>Moving</h6>
                            <p>Collating captured photos at the events and using these photos to make
                ...
                <div class="col-md-6">
                    <div class="blogCard">
                        <figure class="reveal">
                            <img src="images/invitation10.jpg" alt="">
                        </figure>
                        <div class="blogContent">
                            <h6>Entertaining Invitations</h6>
                            <p>Collating captured photos at the events and using these photos to make
                                E-magazine. Sending these E-magazine to preferred guest of the celebrators through our
                                website</p>
                            <a href="" class="themeBtn">Get Started</a>
    ...
    <section data-scroll-section class="instaSec">
        <div class="container">
            <h2 class="secHeading">Follow Us On Instagram <a href="#"><i class="fab fa-instagram"></i></a></h2>
            <div class="row">
                <div class="col-md-12">
