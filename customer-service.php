<?php include 'include/header.php' ?>
    <title>Celebrant - Customer Service</title>
...
<?php include 'include/menu.php' ?>
                    ...
                    <div class="slide-inner">
                        <div class="container">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-lg-5">
                                    <h2 data-swiper-parallax="-200">Customer Service</h2>
                                </div>
                                <div class="col-lg-6">
                                    <div class="slideIMg">
                                        <figure>
    ...
    <section data-scroll-section class="contactPage">
        <div class="container">
            ...
            <form action="">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <ul>
                            <li><a href="#"><img src="images/robotimg.png" class="img-fluid" alt="img"></a></li>
                            <li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="cntctpg">
                        <a href="tel:1234567890"><i class="fas fa-phone-alt"></i>12345 67890</a>
                        <a href="mailto:support@gmail.com"><i class="fas fa-envelope"></i>support@gmail.com</a>
                    </div>
                </div>
            </div>
        </div>
